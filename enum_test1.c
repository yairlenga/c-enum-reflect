...
static void show_enum(enum_desc_t ed)
{
...
static void test_static(enum_desc_t ed)
{
    show_enum(ed) ;
    ...
    printf("str(VV2)=%s\n", enum_desc_label_of(ed, VV2, "?")) ;
    printf("int(VV4)=%d\n", enum_desc_value_of(ed, "VV4", -9999));
}
...
{
    enum_desc_t e1_desc = enum_desc_build("e1", (enum_desc_entry_t []) { { E1, "E1"}, { E3, "E3" }, { E100, "E100"}, {} }, NULL) ;

    show_enum(e1_desc) ;

    printf("str(E3)=%d\n", enum_desc_find_by_label(e1_desc, "E3")) ;
    printf("val(E100)=%d\n", enum_desc_find_by_value(e1_desc, E100)) ;
    printf("val(-1)=%d\n", enum_desc_find_by_value(e1_desc, -1)) ;
    printf("str(ZZZ)=%d\n", enum_desc_find_by_label(e1_desc, "ZZZ")) ;
